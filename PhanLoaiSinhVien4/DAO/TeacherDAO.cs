    ...
    class TeacherDAO
    {
        ...
        public DataTable Load()
        {
            string query = @"select MaGV as N'Mã giảng viên', TenGV as N'Tên giảng viên', 
                            ...
                            ListSubject as N'Môn giảng dạy' from vwGiangVienVaMon where MaGV not like 'AD%'";
        ...
        public DataTable LoadChoose(string MaM = null)
        {
            ...
            {
                query = @"select gv.MaGV as N'Mã giảng viên', gv.TenGV as N'Tên giảng viên', gv.GioiTinhGV as N'Giới tính', gv.NgaySinhGV as N'Ngày sinh' from GiangVien as gv where MaGV like 'GV%'";
            }
            else
            {
